...
output "api_invoke_url" {
  description = "URL invoke API GW (qua VPN)."
...
output "s3_input_bucket" {
  description = "Bucket video upload."
  value       = module.s3_input.bucket_id
}

output "s3_output_bucket" {
  description = "Bucket video sau nén."
